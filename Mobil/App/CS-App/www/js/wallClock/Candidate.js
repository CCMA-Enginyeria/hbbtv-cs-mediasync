...
var Correlation = window["dvbcss-clocks"].Correlation;
...
var Candidate = function(wcMsg, nanosRx) {
     ...
     */
    this.t1 = WallClockMessage.secsAndNanosToNanos(wcMsg.originate_timevalues.originate_timevalues_secs, wcMsg.originate_timevalues.originate_timevalues_nanos);
    /**
     * @type Number
     * @desc Request received time (in nanoseconds)
     */
    this.t2 = WallClockMessage.secsAndNanosToNanos(wcMsg.receive_timevalues.receive_timevalues_secs, wcMsg.receive_timevalues.receive_timevalues_nanos);
    /**
     * @type Number
     * @desc Response sent time (in nanoseconds)
     */
    this.t3 = WallClockMessage.secsAndNanosToNanos(wcMsg.transmit_timevalues.transmit_timevalues_secs, wcMsg.transmit_timevalues.transmit_timevalues_nanos);
    /**
     * @type Number
