 ...
 */
var WallClockMessage = function(version, type, precision, max_freq_error, originate_timevalues_secs, originate_timevalues_nanos, receive_timevalues_secs, receive_timevalues_nanos, transmit_timevalues_secs, transmit_timevalues_nanos) {
    ...
    var msg = {
        ...
        "originate_timevalues": {
            "originate_timevalues_secs": originate_timevalues_secs,
            "originate_timevalues_nanos": originate_timevalues_nanos
        },
        "receive_timevalues": {
            "receive_timevalues_secs": receive_timevalues_secs,
            "receive_timevalues_nanos": receive_timevalues_nanos
        },
        "transmit_timevalues": {
            "transmit_timevalues_secs": transmit_timevalues_secs,
            "transmit_timevalues_nanos": transmit_timevalues_nanos
        }
    };

    return jsonToHexWC(msg);
}
...
WallClockMessage.makeRequest = function(localSendtimeSecs, localSendTimeNanos) {
    return WallClockMessage(0, WallClockMessage.TYPES.request, 0, 0, localSendtimeSecs, localSendTimeNanos, 0, 0, 0, 0);
};
...
WallClockMessage.prototype.toResponse = function(responseType, precision, max_freq_error, rxTime, txTime) {
    var received = this.nanosToSecsAndNanos(rxTime);
    var transmited = this.nanosToSecsAndNanos(txTime);
