...
function Socket(type) {
    ...
    exec(null, null, 'UDPWallClock', 'create', [ this._socketId, this._multicastSocket ]);
}
...
Socket.prototype.bind = function (port, callback) {
    ...
    console.log("BINDING...");
    exec(callback.bind(null, null), callback.bind(null), 'UDPWallClock', 'bind', [ this._socketId, port ]);
};

Socket.prototype.close = function () {
    exec(null, null, 'UDPWallClock', 'close', [ this._socketId ]);
...
Socket.prototype.joinGroup = function (address, callback) {
    ...
    exec(callback.bind(null, null), callback.bind(null), 'UDPWallClock', 'joinGroup', [ this._socketId, address ]);
};

Socket.prototype.leaveGroup = function (address, callback) {
    callback = callback || function () { };
    if (!this._multicastSocket) throw new Error('Invalid operation');
    exec(callback.bind(null, null), callback.bind(null), 'UDPWallClock', 'leaveGroup', [ this._socketId, address ]);
};
